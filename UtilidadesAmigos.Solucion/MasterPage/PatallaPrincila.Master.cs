...
namespace UtilidadesAmigos.Solucion.MasterPage
{
    public partial class PatallaPrincila : System.Web.UI.MasterPage
    {
        ...
        public void ValidarPantallas() {
            ...
            switch (IdPerfil)
            {
                ...
                case (int)PefilesUsuarios.ADMINISTRADOR:
                    ...
                    //HOJA
                    LinkCertificadoMaritimo.Visible = true;
        ...
        protected void LinkGenerarMarbete_Click(object sender, EventArgs e)
        {
            if (Session["IdUsuario"] != null)
            {
        ...
        protected void LinkMatrizRiesgo_Click(object sender, EventArgs e)
        {
            if (Session["IdUsuario"] != null)
            {
        ...
        protected void LinkAcuerdosPagos_Click(object sender, EventArgs e)
        {
            if (Session["IdUsuario"] != null)
            {
                Response.Redirect("~/Paginas/Gerencia/AcuerdoPago.aspx");
            }
            else
            {
                FormsAuthentication.SignOut();
