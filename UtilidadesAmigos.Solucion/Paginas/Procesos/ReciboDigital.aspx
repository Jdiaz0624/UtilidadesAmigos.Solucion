...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="form-check-inline">
            <label class="Letranegrita"> Opcion a Realizar</label>
            <asp:RadioButton ID="rbRecibosDigital" runat="server" GroupName="TipoOperacion" Text="Recibos Digitales" AutoPostBack="true" OnCheckedChanged="RadiosProcesos" />
            <asp:RadioButton ID="rbCuadreCaja" runat="server" GroupName="TipoOperacion" Text="Cuadre de Caja" AutoPostBack="true" OnCheckedChanged="RadiosProcesos" />
        </div>

        <div id="DIVRecibosDigitales" runat="server">
...
<div class="form-check form-switch">
  ...
  <div id="BloqueReciboDigitalMantenimiento" runat="server">
      ...
      <br />
        ...
        <div id="DIVCuadreCaja" runat="server"></div>
