                ...
                if (rbConsuntaSistema.Checked == true) {
                    ...
                    if (Session["IdUsuario"] != null) {
                        ...
                        else if (rbReporteNeteado.Checked == true)
                        {
                            ...
                            var ExportarInformacionNeteada = (from n in ObDataMantenimiento.Value.BuscaHistorialAntiguedadSaldoNeteado(
                                Convert.ToDecimal(Session["IdUsuario"]),
                                Convert.ToDecimal(txtTasaDollar.Text),
                                Convert.ToDateTime(txtFechaCorte.Text),
                                Convert.ToDateTime(txtFechaGuardado.Text))
                            ...
                            UtilidadesAmigos.Logica.Comunes.ExportarDataExel.exporttoexcel("Historial Antiguedad Saldo Neteado Cortado al " + txtFechaCorte.Text, ExportarInformacionNeteada);
                        ...
                        else if (rbReporteDetallado.Checked == true)
                        {
                            ...
                            UtilidadesAmigos.Logica.Comunes.ExportarDataExel.exporttoexcel("Historial Antiguedad Saldo Detalle Cortado al " + txtFechaCorte.Text, ExportarHistorialDetalle);
                        }
                    }
                    else {
                        FormsAuthentication.SignOut();
