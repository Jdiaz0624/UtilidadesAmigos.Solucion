    ...
    public partial class ComisionesSupervisores : System.Web.UI.Page
    {
        ...
        private void ProcesarComisiones() {
            ...
            foreach (var nCobrado in SacarInformacionCobrado) {
                ...
                Recibo = nCobrado.Numero != null ? (decimal)nCobrado.Numero : 0;
                ...
                CodigoCliente = nCobrado.CodigoCliente != null ? (decimal)nCobrado.CodigoCliente : 0;
                NombreCliente = nCobrado.Cliente;
                CodigoIntermediario = nCobrado.CodigoIntermediario != null ? (decimal)nCobrado.CodigoIntermediario : 0;
                NombreIntermediario = nCobrado.Intermediario;
                CodigoSupervisor = nCobrado.CodSupervisor != null ? (decimal)nCobrado.CodSupervisor : 0;
                NombreSupervisor = nCobrado.NombreSupervisor;
                CodigoOficina = nCobrado.CodigoOficina != null ? (int)nCobrado.CodigoOficina : 0;
                NombreOficina = nCobrado.Oficina;
                Usuario = nCobrado.Usuario;
                CodigoRamo = nCobrado.CodigoRamo != null ? (decimal)nCobrado.CodigoRamo : 0;
                DescripcionRamo = nCobrado.Ramo;
                CodigoMoneda = nCobrado.CodMoneda != null ? (decimal)nCobrado.CodMoneda : 1;
                DescripcionMoneda = nCobrado.Moneda;
                Bruto = nCobrado.Bruto != null ? (decimal)nCobrado.Bruto : 0;
                Impuesto = nCobrado.Impuesto != null ? (decimal)nCobrado.Impuesto : 0;
                Neto = nCobrado.Neto != null ? (decimal)nCobrado.Neto : 0;
                Tasa = nCobrado.Tasa != null ? (decimal)nCobrado.Tasa : 0;
                Pesos = nCobrado.MontoPesos != null ? (decimal)nCobrado.MontoPesos : 0;
