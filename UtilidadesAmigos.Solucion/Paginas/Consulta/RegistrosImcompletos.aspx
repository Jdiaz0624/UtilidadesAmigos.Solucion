...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AccesoDenegado() {
            alert("No tienes permiso para realizar este proceso, favor de contactar con el personal autorizado.");
        }
    ...
    <div class="container-fluid">
        <br />
        <div  class="row">
            <div id="DivClienteSinPolzaRecuento" runat="server" class="col-md-3">
             ...
             <div id="DIVPolizaSinMArbeteRecuento" runat="server" class="col-md-3">
        ...
        <hr />
        <div id="DivRadios" runat="server" class="form-check-inline">
        ...
        <div id="DIVBloqueClientesSinPoliza" visible="true" runat="server">
            <br />
            <div id="DivBloqueListadoClienteSinPoliza" runat="server">
                <div align="center">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                     <asp:Label ID="lbEstatusCliente" runat="server" Text="Estatus" CssClass="LetrasNegrita"></asp:Label>
                     <asp:DropDownList ID="ddlEstatusCliente" runat="server" ToolTip="Seleccionar Estatus" CssClass="form-control"></asp:DropDownList>
                </div>
            </div>
            <br />
           <table class="table table-striped">
            ...
            <div id="DIVBloqueProcesoClienteSinPoliza" runat="server">
                ...
                <div class="form-check-inline">
                    <asp:CheckBox ID="cbAgregarComentario" runat="server" Text="Agregar Comentario" CssClass="LetrasNegrita" AutoPostBack="true" OnCheckedChanged="cbAgregarComentario_CheckedChanged" ToolTip="Agregar Comentario a Este Proceso" />
                </div>
                <div id="DivBloqueComentarioProcesoClienteSinPoliza" runat="server" class="row">
                     <div class="col-md-12">
                        <asp:Label ID="LbComentarioProceso" runat="server" Text="Comentario" CssClass="LetrasNegrita"></asp:Label>
                        <asp:TextBox ID="txtComentario" runat="server" CssClass="form-control" AutoCompleteType="Disabled" TextMode="MultiLine"></asp:TextBox>
                    </div>
                </div>
                <br />
                <div align="center">
                    <asp:ImageButton ID="btnProcesarInformacion" runat="server" ToolTip="Procesar Información" CssClass="BotonImagen" ImageUrl="~/Imagenes/Procesar.png" OnClick="btnProcesarInformacion_Click" />
                    <asp:ImageButton ID="btnVolverAtrasCLienteSinnPoliza" runat="server" ToolTip="Volver Atras" CssClass="BotonImagen" ImageUrl="~/Imagenes/volver-flecha.png" OnClick="btnVolverAtrasCLienteSinnPoliza_Click" />
                </div>
                <br />
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <asp:Repeater ID="rpListadoComentariosClientesSinPoliza" runat="server">
                        <ItemTemplate>
                            <tr>
              ...
              <table class="table">
                <tfoot class="table-light">
                    <tr>
                        <td align="right"><b>Pagina </b> <asp:Label ID="lbPaginaActualComentarios" runat="server" Text=" 0 " CssClass="Letranegrita"></asp:Label> <b>De </b>   <asp:Label ID="lbCantidadPaginaComentarios" runat="server" Text="0" CssClass="Letranegrita"></asp:Label> </td>
                    </tr>
                </tfoot>
            </table>
             <div id="Div1" runat="server" align="center" >
                <div style="margin-top=20px;">
                    <table style="width:600px;">
                        <tr>
                            <td> <asp:ImageButton ID="btnPrimeraPaginaComentarios" runat="server" ImageUrl="~/Imagenes/Primera Pagina.png" OnClick="btnPrimeraPaginaComentarios_Click" CssClass="BotonImagen" ToolTip="Ir a la Primera Pagina" /> </td>
                            <td> <asp:ImageButton ID="btnPaginaAnteriorComentarios" runat="server" ImageUrl="~/Imagenes/Anterior.png" OnClick="btnPaginaAnteriorComentarios_Click" CssClass="BotonImagen" ToolTip="Ir a la Primera Pagina" /> </td>
                            <td align="center">
                                <asp:DataList ID="dtPaginacionListadoPrincipalComentarios" runat="server" OnCancelCommand="dtPaginacionListadoPrincipalComentarios_CancelCommand" OnItemDataBound="dtPaginacionListadoPrincipalComentarios_ItemDataBound" RepeatDirection="Horizontal" >
                                    <ItemTemplate>
                            ...
                            <td> <asp:ImageButton ID="btnSiguientePaginaComentarios" runat="server" ImageUrl="~/Imagenes/Siguiente.png" OnClick="btnSiguientePaginaComentarios_Click" CssClass="BotonImagen" ToolTip="Ir a la Primera Pagina" /> </td>
                            <td> <asp:ImageButton ID="btnUltimaPaginaComentarios" runat="server" ImageUrl="~/Imagenes/Ultima Pagina.png" OnClick="btnUltimaPaginaComentarios_Click" CssClass="BotonImagen" ToolTip="Ir a la Primera Pagina" /> </td>
