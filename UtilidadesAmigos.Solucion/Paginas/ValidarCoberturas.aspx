...
<!--INICIO DE LOS MENUS DESPLEGABLES Y CONTROLES DE BUSQUEDA-->
    <div class="container-fluid">
        ...
        <div class="form-check-inline">
                ...
                <div class="form-group form-check">
                    <asp:RadioButton ID="rbExportartxt" runat="server" Text="Exportar a TXT" CssClass="form-check-input" ToolTip="Exportar a formato de texto plano delimitado por |" GroupName="Exportar" />
                </div>
            </div>
