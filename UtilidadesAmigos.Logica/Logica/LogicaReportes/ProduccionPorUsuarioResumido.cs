...
namespace UtilidadesAmigos.Logica.Logica.LogicaReportes
{
    public class ProduccionPorUsuarioResumido
    {
        ...
        /// <returns></returns>
        public List<UtilidadesAmigos.Logica.Entidades.Reportes.EMarbeteTransito> GenerarMarbeteTransito(string Poliza = null, int? Item = null, DateTime? FechaDesde = null, DateTime? FechaHasta = null, int? Supervisor = null, int? Intermediario = null, int? Oficina = null, string PolizaImpresa = null) {

            ObjData.CommandTimeout = 999999999;

            var Informacion = (from n in ObjData.SP_GENERAR_MARBETE_VEHICULO_TRANSITO(Poliza, Item, FechaDesde, FechaHasta, Supervisor, Intermediario, Oficina, PolizaImpresa)
                               select new UtilidadesAmigos.Logica.Entidades.Reportes.EMarbeteTransito
                               {
                                   Poliza=n.Poliza,
                                   ValorAnual=n.ValorAnual,
