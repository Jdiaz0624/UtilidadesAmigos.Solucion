...
{
    public class EProcesarInformacionGuardarAntiguedadPorAtraso
    {
        public System.Nullable<decimal> IdUsuario {get;set;}

        public string Poliza {get;set;}

        public System.Nullable<int> Codigo_Intermediario {get;set;}

        public string Intermediario {get;set;}

        public System.Nullable<int> Codigo_Supervisor {get;set;}

        public string Supervisor {get;set;}

        public System.Nullable<decimal> Codigo {get;set;}
