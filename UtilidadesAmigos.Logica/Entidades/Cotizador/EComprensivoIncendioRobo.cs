...
{
    public class EComprensivoIncendioRobo
    {
        public decimal? IdTipoCotizador { get; set; }

        public string TipoCotizador { get; set; }

        public decimal? IdValorVehiculo { get; set; }
        ...
        public decimal? IdComprensivoIncendioRobo { get; set; }

        public string ComprensivoIncendioRobo { get; set; }
