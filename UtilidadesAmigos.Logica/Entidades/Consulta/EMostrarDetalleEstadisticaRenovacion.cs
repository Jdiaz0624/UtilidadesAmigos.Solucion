...
namespace UtilidadesAmigos.Logica.Entidades.Consulta
{
    public class EMostrarDetalleEstadisticaRenovacion
    {
		...
		public string UltimoComentarioGestionCobros { get; set; }

		public string UltimoEstatusLLamdaGestionCobros { get; set; }

		public string UltimoConceptoLlamadaGestionCobros { get; set; }

		public string UltimoComentarioGestionCobros_AntiguedadSaldo { get; set; }

		public string UltimoEstatusLLamdaGestionCobros_AntiguedadSaldo { get; set; }

		public string UltimoConceptoLlamadaGestionCobros_AntiguedadSaldo { get; set; }
	}
}
