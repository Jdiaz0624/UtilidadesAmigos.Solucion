...
{
    public class EBuscaHistoricoImpresionMarbetes
    {
        ...
        public System.Nullable<int> TipoImpresion0 {get;set;}

        public string TipoImpresion {get;set;}

        public System.Nullable<int> CantidadImpreso {get;set;}

        public System.Nullable<int> CandidadImpresionesPVC {get;set;}

        public System.Nullable<int> CandidadImpresionesHoja {get;set;}

        public System.Nullable<int> CandidadImpresiones {get;set;}

        public System.Nullable<int> CandidadRegistros {get;set;}
    }
}
