...
{
    public class ProcesarInformacionDatosProduccionReporte
    {
        ...
        public ProcesarInformacionDatosProduccionReporte(
        ...
        public void ProcesarInformacionDatoReporte() {
            UtilidadesAmigos.Logica.Entidades.Reportes.EDatosProduccionReporte Procesar = new Entidades.Reportes.EDatosProduccionReporte();
            ...
            var MAN = ObjData.ProcesarInformacionDatosReporte(Procesar, Accion);
        }
    }
}
